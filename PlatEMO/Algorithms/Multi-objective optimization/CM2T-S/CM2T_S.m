        ...
        function main(Algorithm,Problem)
           %% Parameter setting
            ...
            while Algorithm.NotTerminated(Population)
                ...
                %{
                % サブ個体群から代表点を取り出す．
                % 出力される個体群サイズは，Problem.N．
                for i = 1 : Problem.N
                    Population(i) = SubPopulation(i,TournamentSelection(S,1,SubPop_Constraint_value(i,:),SubPop_Scalarizing_value(i,:)));
                end
                %}
            end
        end
