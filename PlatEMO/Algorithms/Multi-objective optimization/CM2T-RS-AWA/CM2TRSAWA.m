    ...
    methods
        function main(Algorithm,Problem)
           %% Parameter setting
            ...
            [S,type,rate_update_weight,rate_evol,rate_evol2,wag,evaluation] = Algorithm.ParameterSet(20,3,0.05,0.8,0.5,100,1);
            ...
            while Algorithm.NotTerminated(Population)
                ...
                if Problem.FE > rate_evol2*Problem.maxFE
                    epsilon = maxCV*((Problem.maxFE-Problem.FE)/(Problem.maxFE*(1-rate_evol)));
                else
