classdef NSGAIICVM < ALGORITHM
    ...
    methods
        function main(Algorithm, Problem)
            ...
            [Population,FrontNo,CrowdDis] = EnvironmentalSelectionCVM(Population, Problem.N);
            f = 0;  
            gen = 1;
            %% 1.1 CSVファイルを用意（世代ごとの可行解割合を記録）
            % （必要に応じてファイル名や出力形式を変更してください）
            filename = sprintf('/Users/azumayuki/Documents/LONs/feasible_ratio_CV/RWMOP%d_CVM.csv', pn);
            filename2 = sprintf('/Users/azumayuki/Documents/LONs/feasible_first_CV/RWMOP%d_CVM_first.csv', pn);
            ...
            while Algorithm.NotTerminated(Population)
                ...
                % 2.3 次世代選択（CDPベース）
                [Population,FrontNo,CrowdDis] = EnvironmentalSelectionCVM([Population,Offspring], Problem.N);
