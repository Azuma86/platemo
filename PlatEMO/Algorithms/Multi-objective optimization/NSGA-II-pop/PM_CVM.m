classdef PM_CVM < ALGORITHM
    ...
    methods
        function main(Algorithm,Problem)
            ...
            csvFilename = sprintf('/Users/azumayuki/Documents/LONs/data09-20-pre/RWMOP%d_CVM.csv',pn);
            ...
            while Algorithm.NotTerminated(Population)
                ...
                if all(stableCount >= stableThreshold)
                    ...
                    fprintf("CVM:実行可能解割合：%f 平均到達世代:%f\n",ratio,mean_gen)
                    break;
                end
                PrevPopulation = Population;
            end
