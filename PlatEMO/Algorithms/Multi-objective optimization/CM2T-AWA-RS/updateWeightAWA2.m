function [Population,Del,W] = updateWeightAWA2(Population,SubPopulation,W,Z,EP,nus,T)
...
%--------------------------------------------------------------------------
    ...
    feasible_index = find(sum(max(0,Combine.cons),2) == 0);
    Combine = Combine(feasible_index);
